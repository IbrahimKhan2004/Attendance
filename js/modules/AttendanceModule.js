      ...
      return `<div class="ios-list-item">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.5rem;">
          ...
          <div style="display:flex; align-items:center; gap:0.5rem; position:relative;">
            ...
            <button onclick="window.toggleDayMenu('${dateKey}')" aria-label="More options" style="background:transparent; border:none; color:var(--muted); font-size:1rem; padding:2px 6px; line-height:1;">⋮</button>
            ${menu}
          </div>
        </div>
